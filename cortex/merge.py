...
_warnings.warn(
    "cortex.merge is deprecated; use cortex.versioning.merge instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.versioning.merge import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.versioning.merge")
globals().update(
    {
        _name: _value
