...
_warnings.warn(
    "cortex.http_hardening is deprecated; use cortex.service.http_hardening instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.http_hardening import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.service.http_hardening")
globals().update(
    {
        _name: _value
