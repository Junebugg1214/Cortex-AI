...
_warnings.warn(
    "cortex.service is deprecated; use cortex.service.service instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.service import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.service.service")
