...
_warnings.warn(
    "cortex.mind_mounts is deprecated; use cortex.portability.mind_mounts instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.portability.mind_mounts import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.portability.mind_mounts")
globals().update(
    {
        _name: _value
