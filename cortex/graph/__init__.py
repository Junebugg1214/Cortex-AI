...
_warnings.warn(
    "cortex.graph is deprecated; use cortex.graph.graph instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.graph import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.graph")
