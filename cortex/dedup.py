...
_warnings.warn(
    "cortex.dedup is deprecated; use cortex.graph.dedup instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.dedup import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.dedup")
globals().update(
    {
        _name: _value
