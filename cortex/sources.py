...
_warnings.warn(
    'cortex.sources is deprecated; use cortex.extraction.sources instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.extraction.sources import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.extraction.sources')
globals().update({
    _name: _value
