...
_warnings.warn(
    'cortex.integrity is deprecated; use cortex.graph.integrity instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.integrity import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.graph.integrity')
globals().update({
    _name: _value
