...
_warnings.warn(
    'cortex.query_lang is deprecated; use cortex.graph.query_lang instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.query_lang import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.graph.query_lang')
globals().update({
    _name: _value
