...
_warnings.warn(
    'cortex.search is deprecated; use cortex.graph.search instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.search import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.graph.search')
globals().update({
    _name: _value
