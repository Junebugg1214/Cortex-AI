...
_warnings.warn(
    'cortex.webapp is deprecated; use cortex.service.webapp instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.webapp import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.service.webapp')
globals().update({
    _name: _value
