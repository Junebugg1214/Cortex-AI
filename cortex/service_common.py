...
_warnings.warn(
    "cortex.service_common is deprecated; use cortex.service.service_common instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.service_common import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.service.service_common")
globals().update(
    {
        _name: _value
