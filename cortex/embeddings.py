...
_warnings.warn(
    "cortex.embeddings is deprecated; use cortex.extraction.embeddings instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.extraction.embeddings import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.extraction.embeddings")
globals().update(
    {
        _name: _value
