...
_warnings.warn(
    "cortex.portable_state is deprecated; use cortex.portability.portable_state instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.portability.portable_state import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.portability.portable_state")
globals().update(
    {
        _name: _value
