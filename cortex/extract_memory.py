...
_warnings.warn(
    "cortex.extract_memory is deprecated; use cortex.extraction.extract_memory instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.extraction.extract_memory import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.extraction.extract_memory")
globals().update(
    {
        _name: _value
