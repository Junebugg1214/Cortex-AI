...
_warnings.warn(
    "cortex.portable_views is deprecated; use cortex.portability.portable_views instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.portability.portable_views import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.portability.portable_views")
globals().update(
    {
        _name: _value
