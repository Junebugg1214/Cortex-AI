...
_warnings.warn(
    "cortex.edge_extraction is deprecated; use cortex.graph.edge_extraction instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.edge_extraction import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.edge_extraction")
globals().update(
    {
        _name: _value
