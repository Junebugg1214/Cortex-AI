...
_build_connect_manus_serve_command = cli_runtime_module._build_connect_manus_serve_command
_connect_runtime_config_snippet = cli_runtime_module._connect_runtime_config_snippet
_connect_runtime_content_paths = cli_runtime_module._connect_runtime_content_paths
_connect_runtime_context_status = cli_runtime_module._connect_runtime_context_status
_connect_runtime_format = cli_runtime_module._connect_runtime_format
_connect_runtime_mcp_config_path = cli_runtime_module._connect_runtime_mcp_config_path
_connect_runtime_next_steps = cli_runtime_module._connect_runtime_next_steps
_connect_runtime_upsert_target_config = cli_runtime_module._connect_runtime_upsert_target_config
_normalize_manus_url = cli_runtime_module._normalize_manus_url
_select_scoped_api_key = cli_runtime_module._select_scoped_api_key
_serve_check_payload = cli_runtime_module._serve_check_payload
