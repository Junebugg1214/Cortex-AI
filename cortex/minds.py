...
_warnings.warn(
    "cortex.minds is deprecated; use cortex.graph.minds instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.minds import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.minds")
