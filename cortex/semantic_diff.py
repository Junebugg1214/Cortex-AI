...
_warnings.warn(
    "cortex.semantic_diff is deprecated; use cortex.graph.semantic_diff instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.semantic_diff import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.semantic_diff")
globals().update(
    {
        _name: _value
