...
_warnings.warn(
    'cortex.openapi is deprecated; use cortex.service.openapi instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.openapi import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.service.openapi')
globals().update({
    _name: _value
