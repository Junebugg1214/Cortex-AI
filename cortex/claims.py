...
_warnings.warn(
    "cortex.claims is deprecated; use cortex.graph.claims instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.claims import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.graph.claims")
globals().update(
    {
        _name: _value
