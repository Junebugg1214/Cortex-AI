...
_warnings.warn(
    "cortex.server is deprecated; use cortex.service.server instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.service.server import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.service.server")
globals().update(
    {
        _name: _value
