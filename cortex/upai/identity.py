...
_warnings.warn(
    "cortex.upai.identity is deprecated; use cortex.versioning.upai.identity instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.versioning.upai.identity import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.versioning.upai.identity")
globals().update(
    {
        _name: _value
