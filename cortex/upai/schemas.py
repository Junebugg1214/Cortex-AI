...
_warnings.warn(
    "cortex.upai.schemas is deprecated; use cortex.versioning.upai.schemas instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.versioning.upai.schemas import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.versioning.upai.schemas")
globals().update(
    {
        _name: _value
