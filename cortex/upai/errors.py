...
_warnings.warn(
    "cortex.upai.errors is deprecated; use cortex.versioning.upai.errors instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.versioning.upai.errors import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.versioning.upai.errors")
globals().update(
    {
        _name: _value
