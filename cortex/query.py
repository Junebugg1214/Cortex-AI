...
_warnings.warn(
    'cortex.query is deprecated; use cortex.graph.query instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.query import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.graph.query')
globals().update({
    _name: _value
