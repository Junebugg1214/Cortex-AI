...
_warnings.warn(
    'cortex.temporal is deprecated; use cortex.graph.temporal instead.',
    DeprecationWarning,
    stacklevel=2,
)
from cortex.graph.temporal import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module('cortex.graph.temporal')
globals().update({
    _name: _value
