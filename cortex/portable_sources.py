...
_warnings.warn(
    "cortex.portable_sources is deprecated; use cortex.portability.portable_sources instead.",
    DeprecationWarning,
    stacklevel=2,
)
from cortex.portability.portable_sources import *  # pragma: deprecation  # noqa: F401,F403,E402

_module = _import_module("cortex.portability.portable_sources")
globals().update(
    {
        _name: _value
