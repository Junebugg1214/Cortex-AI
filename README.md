...
- OpenClaw-native plugin starter kit: proposed `openclaw.plugin.json`, config schema, hook lifecycle, MCP service behavior, and install UX. See [docs/OPENCLAW_NATIVE_PLUGIN.md](docs/OPENCLAW_NATIVE_PLUGIN.md).
